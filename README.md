- Цель данного pet-проекта заключается в закреплении изученого материала: интерфейсы, конкуретное взаимодействие на Golang, HTTP и REST API
---

1. Я разработал игру, в которой будет возможно управлять предприятием "Угольная шахта".
...
14. Во время проектирования HTTP-контракта сервера игры пользовался парадигмой REST API.
